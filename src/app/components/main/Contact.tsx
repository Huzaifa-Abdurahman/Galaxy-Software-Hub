  ...
  return (
    <div className='h-full w-full flex flex-col justify-center items-center p-20 mt-8 text-gray-200' id="contact">
      ...
      <div className='flex flex-col md:flex-row gap-10 px-10 '>
        <div className=' overflow-hidden rounded-lg shadow-lg border border-[#2A0E61] m-2 p-2 py-6 px-6 flex flex-col'>
        ...
        <div className='relative overflow-hidden rounded-lg shadow-lg border border-[#2A0E61] m-2 p-2 py-6 px-6  flex flex-col '>
          <div className='font-sans text-2xl'><div> E-Mail <Image src="/gmail.png" width={24} height={24} alt='gmail' className='bg-white'/></div> 
            abdurahhuzaifa393@gmail.com  <a href="mailto:abdurahhuzaifa393@gmail.com">Send email</a>
          </div>
